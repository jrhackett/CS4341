...
public class Referee
{
	...
	static Player player1 = new OurPlayerJH("Player 1", 1, timeLimit); // you should create your own player class and use it here
	static Player player2 = new OurPlayerJH("Player 2", 2, timeLimit);
